...
public class SquidArmorAugment implements AugmentingSpirit
{
    @Override
    public String augmentTag()
    {
        return MalumMod.squid_armor_augment;
    }
    ...
    {
        return "SQUID: Increases your horizontal swim speed";
    }

    @Override
    public void handleTooltip(@Nonnull CompoundNBT nbt, List<ITextComponent> tooltip)
    {
        tooltip.add(new StringTextComponent("SQUID " + nbt.getInt(augmentDescription() + nbt.getInt(MalumMod.ender_dragon_armor_augment))));
    }
