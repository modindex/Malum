...
import kittykitcatcat.malum.rituals.CrystalHarvestRitualEffect;
import kittykitcatcat.malum.rituals.TransmutationRitualEffect;
...
public class RitualRecipes
{
    ...
    public static void initRecipes()
    {
        ...
        ModRecipes.addRitualRecipe(new RitualRecipe(crystalGrowthItems, new CrystalHarvestRitualEffect()));
    }
}
